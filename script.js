function clearAll() {
    const meme = document.querySelector('#memes');
    const joke = document.querySelector('#jokes');
    const quote = document.querySelector('#quotes');
    const riddle = document.querySelector('#riddles');
...
function formatObj(obj) {
    const formattedQuote = obj.quote;
    const formattedAuthor = obj.author;
...
function showQuote() {
    ...
    newQuote.style.color = "gray";
    const objStr = formatObj(randomQuote);
    newQuote.textContent = objStr;
...
function showRiddle() {
    ...
    const riddleContainer = document.querySelector("#riddles");
    ...
    newRiddleAnswer.setAttribute('class', 'riddle-answer');
...
function revealAnswers() {
    const riddleContent = document.querySelector("#riddles");
